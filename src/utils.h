...
qrFactor(const arma::Mat<double>& A, //J
         const arma::Mat<double>& S, //P0
         const arma::Mat<double>& Ns //Q
         ) {
    //std::cout << " +++ qrFactor +++" << std::endl;
    //std::cout << " J:" << std::endl << A << std::endl;
    //std::cout << " P0:" << std::endl << S << std::endl;
    //std::cout << " Q:" << std::endl << Ns << std::endl;
    //std::cout << " ---------------"<< std::endl;
    //arma::Mat<double> S_t = S.t();
    //std::cout << " P0_t:" << std::endl << S_t << std::endl;
    //arma::Mat<double> A_t = A.t();
    //std::cout << " J_t:" << std::endl << A_t << std::endl;
    //arma::Mat<double> AS_t = S.t()*A.t();
    //std::cout << " P0_t*J_t:" << std::endl << AS_t << std::endl;
    //arma::Mat<double> Ns_t = Ns.t();
    //std::cout << " Q_t:" << std::endl << Ns_t << std::endl;
    //arma::Mat<double> JC1 = join_cols(S.t()*A.t(),Ns.t());
    //std::cout << " join_cols(P0.t()*J.t(),Q.t()):" << std::endl << JC1 << std::endl;
    //std::cout << std::endl;
    //std::cout << " +++++++++++++++" << std::endl;

    arma::Mat<double> D = join_cols(S.t()*A.t(),Ns.t()), Q, R;
    //std::cout << " D:" << std::endl << D << std::endl;
    //std::cout << " Q_:" << std::endl << Q << std::endl;
    //std::cout << " R_:" << std::endl << R << std::endl;
    //std::cout << std::endl;
    //std::cout << " +++++++++++++++ - 2" << std::endl;
